...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Build static HTML sites from ERB/Phlex with working JavaScript"
  spec.description   = "A Ruby gem for building static HTML sites. Uses ActionView to render partials, layouts, and helpers using ERB or Phlex. Compiles to static HTML with JavaScript support. Flexible stack options for bundlers, CSS frameworks, and JS libraries. No backend required."
